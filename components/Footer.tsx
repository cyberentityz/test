...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#000", borderTop: "1px solid rgba(232,28,28,0.2)", padding: "60px 5% 30px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 60, marginBottom: 50 }} className="footer-grid">
          {/* Brand */}
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
              <Image src="/CLogo.jpeg" alt="CyberEntityz" width={44} height={44} />
              <span className="font-orbitron" style={{ fontSize: "1.2rem", fontWeight: 900, color: "#ff2020", textShadow: "0 0 15px #ff2020" }}>CYBERENTITYZ</span>
            </div>
            <p style={{ fontSize: "0.9rem", lineHeight: 1.7, color: "#6b8299", maxWidth: 300 }}>
              Ethical Hacking Society. Delivering world-class cybersecurity training and enterprise solutions from Chennai to the world.
            </p>
            <div style={{ marginTop: 24, display: "flex", gap: 12 }}>
              <div style={{ width: 38, height: 38, border: "1px solid rgba(232,28,28,0.3)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 0.3s", fontSize: "1rem" }}
                onMouseEnter={(e) => { const el = e.currentTarget; el.style.borderColor = "#ff6a00"; el.style.background = "rgba(255,106,0,0.1)"; }}
                onMouseLeave={(e) => { const el = e.currentTarget; el.style.borderColor = "rgba(232,28,28,0.3)"; el.style.background = "transparent"; }}>
                <a href=" https://chat.whatsapp.com/G7UeSNxGIh17lJVxgIIX0n" target="_blank">
              ...
              <div style={{ width: 38, height: 38, border: "1px solid rgba(232,28,28,0.3)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 0.3s", fontSize: "1rem" }}
                onMouseEnter={(e) => { const el = e.currentTarget; el.style.borderColor = "#ff6a00"; el.style.background = "rgba(255,106,0,0.1)"; }}
                onMouseLeave={(e) => { const el = e.currentTarget; el.style.borderColor = "rgba(232,28,28,0.3)"; el.style.background = "transparent"; }}>
                <a href="https://www.instagram.com/cyberentityz?igsh=MTQ5aDdoNXQ0cWxqcA==" target="_blank">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
              ...
              <div style={{ width: 38, height: 38, border: "1px solid rgba(232,28,28,0.3)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 0.3s", fontSize: "1rem" }}
                onMouseEnter={(e) => { const el = e.currentTarget; el.style.borderColor = "#ff6a00"; el.style.background = "rgba(255,106,0,0.1)"; }}
                onMouseLeave={(e) => { const el = e.currentTarget; el.style.borderColor = "rgba(232,28,28,0.3)"; el.style.background = "transparent"; }}>
                <a href="https://www.facebook.com/share/1CWFML5nvn/?mibextid=wwXIfr" target="_blank">
              ...
              <div style={{ width: 38, height: 38, border: "1px solid rgba(232,28,28,0.3)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 0.3s", fontSize: "1rem" }}
                onMouseEnter={(e) => { const el = e.currentTarget; el.style.borderColor = "#ff6a00"; el.style.background = "rgba(255,106,0,0.1)"; }}
                onMouseLeave={(e) => { const el = e.currentTarget; el.style.borderColor = "rgba(232,28,28,0.3)"; el.style.background = "transparent"; }}>
                <a href="http://x.com/cyberentityz?s=21" target="_blank">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
              ...
              <div style={{ width: 38, height: 38, border: "1px solid rgba(232,28,28,0.3)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 0.3s", fontSize: "1rem" }}
                onMouseEnter={(e) => { const el = e.currentTarget; el.style.borderColor = "#ff6a00"; el.style.background = "rgba(255,106,0,0.1)"; }}
                onMouseLeave={(e) => { const el = e.currentTarget; el.style.borderColor = "rgba(232,28,28,0.3)"; el.style.background = "transparent"; }}>
                <a href="https://www.linkedin.com/company/cyberentityz/" target="_blank">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
          ...
          {/* Services */}
          <div>
            <h4 className="font-orbitron" style={{ fontSize: "0.82rem", fontWeight: 700, color: "#fff", letterSpacing: 2, textTransform: "uppercase", marginBottom: 20 }}>Services</h4>
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 10 }}>
              {serviceLinks.map((s) => (
                <li key={s}>
                  <Link href="#services" className="font-mono-tech" style={{ fontSize: "0.78rem", color: "#6b8299", textDecoration: "none", transition: "color 0.3s" }}
                    onMouseEnter={(e) => { (e.target as HTMLElement).style.color = "#ff6a00"; }}
                    onMouseLeave={(e) => { (e.target as HTMLElement).style.color = "#6b8299"; }}>
                    {s}
                  </Link>
                </li>
              ))}
          ...
          {/* Certs */}
          <div>
            <h4 className="font-orbitron" style={{ fontSize: "0.82rem", fontWeight: 700, color: "#fff", letterSpacing: 2, textTransform: "uppercase", marginBottom: 20 }}>Certifications</h4>
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 10 }}>
              {certLinks.map((c) => (
                <li key={c}>
                  <Link href="#certifications" className="font-mono-tech" style={{ fontSize: "0.78rem", color: "#6b8299", textDecoration: "none", transition: "color 0.3s" }}
                    onMouseEnter={(e) => { (e.target as HTMLElement).style.color = "#ff6a00"; }}
                    onMouseLeave={(e) => { (e.target as HTMLElement).style.color = "#6b8299"; }}>
                    {c}
                  </Link>
        ...
        {/* Bottom */}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 30, borderTop: "1px solid rgba(255,255,255,0.06)", flexWrap: "wrap", gap: 12 }}>
          <p className="font-mono-tech" style={{ fontSize: "0.7rem", color: "#6b8299", letterSpacing: 1 }}>
            © {year} <span style={{ color: "#e81c1c", textShadow: "0 0 10px #e81c1c" }}>CYBERENTITYZ™</span> — Ethical Hacking Society. All Rights Reserved.
          </p>
          <div className="font-mono-tech" style={{ fontSize: "0.65rem", color: "#6b8299", letterSpacing: 1, display:"flex", alignItems:"center", gap:3 }}>
          <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p>Teynampet, Chennai · Tamil Nadu, India</p>
          </div>
        </div>
      </div>
